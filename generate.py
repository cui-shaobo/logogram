...
from training.finetunetrainer import FinetuneTrainer
...
def main():
    ...
    parser.add_argument("--test_jsonl_file", type=str,
                        default="./data/single_word_with_replacement_test.jsonl",
                        help="test file for transformer")
    ...
    parser.add_argument("--model_mode", type=str, choices=['abstract2description',
                                                           ...
                                                           'abstract2description-shorthand'],
